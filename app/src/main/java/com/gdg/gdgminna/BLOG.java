...
public class BLOG extends Fragment {
    ...
    public void onStart() {
        super.onStart();
        mwebView = (WebView) getView().findViewById(R.id.webViewblog);
        this.loadingProgressBar = (ProgressBar) getView().findViewById(R.id.progressbar_Horizontal);
        ...
        NetworkInfo nInfo = ((ConnectivityManager)getActivity().getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
            if(nInfo == null || !nInfo.isConnected()) {
                ...
                //View.setVisibility(ImageView.VISIBLE);
                    ...
                    mwebView.loadUrl("http://www.gdgminna.blogspot.com");
                }
            ...
            mwebView.setWebChromeClient(new WebChromeClient(){
                public void onProgressChanged(WebView view, int newProgress){
                    ...
                    BLOG.this.loadingProgressBar.setProgress(newProgress);
                    if(newProgress == 100) {
                        BLOG.this.loadingProgressBar.setVisibility(getView().GONE);
                    }else{
                        BLOG.this.loadingProgressBar.setVisibility(getView().VISIBLE);
                    }
                }
            });
