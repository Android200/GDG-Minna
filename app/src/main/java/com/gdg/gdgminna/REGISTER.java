...
public class REGISTER extends Fragment {
    ...
    public void onStart() {
        super.onStart();
        mwebView = (WebView) getView().findViewById(R.id.webViewregister);
        this.loadingProgressBar = (ProgressBar) getView().findViewById(R.id.progressbar_register);
        ...
        if(nInfo == null || !nInfo.isConnected()) {
            ...
            mwebView.loadUrl("https://docs.google.com/forms/d/1ZoR9T6LTxERRjTL-TUrmMOW-SJjVN_76lquinFhcn-8/viewform");
        }
        ...
        mwebView.setWebChromeClient(new WebChromeClient(){
            ...
            public void onProgressChanged(WebView view, int newProgress){
                ...
                REGISTER.this.loadingProgressBar.setProgress(newProgress);
                if(newProgress == 100) {
                    REGISTER.this.loadingProgressBar.setVisibility(getView().GONE);
                }else{
                    REGISTER.this.loadingProgressBar.setVisibility(getView().VISIBLE);
                }
            }
        });
